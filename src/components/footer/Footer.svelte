	...
	<div class="border-t-2">
		...
		<div class="grid grid-cols-2 lg:grid-cols-4 2xl:grid-cols-6 gap-8 py-10">
			...
			<div class="lg:mx-auto text-left">
				...
				<ul class="text-sm transition-all duration-500">
					<li class="mb-6">
						<a href="/#" class="text-gray-600 hover:text-gray-900">Figma UI System</a>
					</li>
					<li class="mb-6">
						<a href="/#" class=" text-gray-600 hover:text-gray-900">Icons Assets</a>
					</li>
					<li class="mb-6">
		...
		<div class="py-7 border-t border-gray-200">
			<div class="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
				<span class="text-sm text-gray-500">
					2024 - 2025 Peta Konektivitas, All rights reserved.
				</span>
